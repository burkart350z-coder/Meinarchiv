const CACHE="meinarchiv-v25";
const APP=["./","./index.html","./styles.css","./app.js","./preview-fix.js","./powerpay-fix.js","./archive-tools.js","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
